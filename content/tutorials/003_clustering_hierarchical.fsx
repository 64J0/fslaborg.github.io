...
<div id="ce60e03c-b286-4c91-bb81-d71a9cc054ce"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_ce60e03cb2864c91bb81d71a9cc054ce = function() {
            ...
            Plotly.newPlot('ce60e03c-b286-4c91-bb81-d71a9cc054ce', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_ce60e03cb2864c91bb81d71a9cc054ce();
                };
...
<div id="e44a30cf-3dc8-419f-9e92-9c4e3022d34f"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_e44a30cf3dc8419f9e929c4e3022d34f = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('e44a30cf-3dc8-419f-9e92-9c4e3022d34f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_e44a30cf3dc8419f9e929c4e3022d34f();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

...
<div id="c87ef856-a913-4e48-9ce0-b107c63a237c"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c87ef856a9134e489ce0b107c63a237c = function() {
            ...
            Plotly.newPlot('c87ef856-a913-4e48-9ce0-b107c63a237c', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_c87ef856a9134e489ce0b107c63a237c();
                };
...
<div id="c0f84e2f-30a7-4cbd-8398-37b5ed327ab7"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_c0f84e2f30a74cbd839837b5ed327ab7 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('c0f84e2f-30a7-4cbd-8398-37b5ed327ab7', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_c0f84e2f30a74cbd839837b5ed327ab7();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

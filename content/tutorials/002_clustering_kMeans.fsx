...
<div id="be7e29b9-9992-47b0-b4f6-9510a9049568"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_be7e29b9999247b0b4f69510a9049568 = function() {
            ...
            Plotly.newPlot('be7e29b9-9992-47b0-b4f6-9510a9049568', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_be7e29b9999247b0b4f69510a9049568();
                };
...
<script type="text/javascript">
            ...
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_635f61cc566f4efc928abb0c5205b1b0();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<script type="text/javascript">
            ...
            var config = {"responsive":true};
            Plotly.newPlot('d165dcec-8195-4e26-a9de-4c49cd48b27b', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_d165dcec81954e26a9de4c49cd48b27b();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
The identification of the optimal cluster number **k** in terms of the average squared distance of each point to its centroid
can be realized by performing the clustering over a range of **k**'s multiple times and taking the **k** according to the elbow criterion.
...
<div id="25ae0ebf-f12a-44cb-8d2e-5114ee33c8a1"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_25ae0ebff12a44cb8d2e5114ee33c8a1 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {

            var data = [{"type":"scatter","mode":"lines","x":[2,3,4,5,6,7,8,9,10],"y":[2.6540379473960134,0.9614995140825391,0.3206471397129961,0.2390477433328464,0.18637373126884255,0.13314156767937044,0.12062586989010134,0.10471590722598856,0.07920941706334654],"marker":{},"line":{},"error_y":{"array":[0.0,0.836417036706712,0.1015355890287735,0.09597468445431329,0.036825587794243726,0.024861905303898372,0.04017646330118196,0.044279738555092915,0.023059330623249778]}}];
            ...
            var config = {"responsive":true};
            Plotly.newPlot('25ae0ebf-f12a-44cb-8d2e-5114ee33c8a1', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_25ae0ebff12a44cb8d2e5114ee33c8a1();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

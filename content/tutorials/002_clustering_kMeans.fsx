...
<div id="d5becec6-26b9-4578-b7e5-43e637c89cec"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_d5becec626b94578b7e543e637c89cec = function() {
            ...
            Plotly.newPlot('d5becec6-26b9-4578-b7e5-43e637c89cec', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_d5becec626b94578b7e543e637c89cec();
                };
...
<script type="text/javascript">
            ...
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_c54de1bf146c46dd818bc49d327e301b();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<script type="text/javascript">
            ...
            var config = {"responsive":true};
            Plotly.newPlot('b057d040-4622-4925-9674-0c4d7ea38b4f', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_b057d0404622492596740c4d7ea38b4f();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<div id="53af20ed-659e-442f-b145-9389ba850ab6"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_53af20ed659e442fb1459389ba850ab6 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {

            var data = [{"type":"scatter","mode":"lines","x":[2,3,4,5,6,7,8,9,10],"y":[2.6540379473960134,1.3351498148832464,0.34152365544676455,0.20827683254702073,0.15070431080774013,0.12705385046965303,0.10492111159361413,0.10202888911071513,0.07997730523671051],"marker":{},"line":{},"error_y":{"array":[0.0,0.9953366161045922,0.11822844858559135,0.028705841852946584,0.026295259410146165,0.04107690571137389,0.04561269423076975,0.03727138141216237,0.02731531585074612]}}];
            ...
            var config = {"responsive":true};
            Plotly.newPlot('53af20ed-659e-442f-b145-9389ba850ab6', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_53af20ed659e442fb1459389ba850ab6();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

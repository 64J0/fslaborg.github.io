...
<div id="2fed433d-9773-4b14-8b08-f4f80fd6c0f9"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_2fed433d97734b148b08f4f80fd6c0f9 = function() {
            ...
            Plotly.newPlot('2fed433d-9773-4b14-8b08-f4f80fd6c0f9', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_2fed433d97734b148b08f4f80fd6c0f9();
                };
...
<div id="012ccff4-9d37-485c-992f-9b1b5e487ab4"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_012ccff49d37485c992f9b1b5e487ab4 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('012ccff4-9d37-485c-992f-9b1b5e487ab4', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_012ccff49d37485c992f9b1b5e487ab4();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<div id="388b2865-43b4-4ce6-8c0c-b6dd930c2c1c"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_388b286543b44ce68c0cb6dd930c2c1c = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('388b2865-43b4-4ce6-8c0c-b6dd930c2c1c', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_388b286543b44ce68c0cb6dd930c2c1c();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {

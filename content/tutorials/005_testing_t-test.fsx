...
**Note: Slight deviations from these requirements can be accepted but strong violations result in an inflated false positive rate. If the variances are not equal a Welch test can be performed.**
**There are some tests out there to check if the variances are equal or if the sample follows a normal distribution, but their effectiveness is discussed.**
**You always should consider the shape of the theoretical background distribution, instead of relying on preliminary tests rashly.**
...
<div id="0ca5a73e-4952-4d18-8a3c-1c759cd0aec2"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_0ca5a73e49524d188a3c1c759cd0aec2 = function() {
            ...
            Plotly.newPlot('0ca5a73e-4952-4d18-8a3c-1c759cd0aec2', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                ...
                script.onload = function(){
                    renderPlotly_0ca5a73e49524d188a3c1c759cd0aec2();
                };
...
<div id="2143b0cc-616f-41c7-b716-e397d9d767b6"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_2143b0cc616f41c7b716e397d9d767b6 = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('2143b0cc-616f-41c7-b716-e397d9d767b6', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_2143b0cc616f41c7b716e397d9d767b6();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
...
<div id="a2e352ca-e34e-42d5-ac6a-18f6b825a0bd"><!-- Plotly chart will be drawn inside this DIV --></div>
<script type="text/javascript">

            var renderPlotly_a2e352cae34e42d5ac6a18f6b825a0bd = function() {
            var fsharpPlotlyRequire = requirejs.config({context:'fsharp-plotly',paths:{plotly:'https://cdn.plot.ly/plotly-2.6.3.min'}}) || require;
            fsharpPlotlyRequire(['plotly'], function(Plotly) {
            ...
            var config = {"responsive":true};
            Plotly.newPlot('a2e352ca-e34e-42d5-ac6a-18f6b825a0bd', data, layout, config);
});
            };
            if ((typeof(requirejs) !==  typeof(Function)) || (typeof(requirejs.config) !== typeof(Function))) {
                var script = document.createElement("script");
                script.setAttribute("src", "https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js");
                script.onload = function(){
                    renderPlotly_a2e352cae34e42d5ac6a18f6b825a0bd();
                };
                document.getElementsByTagName("head")[0].appendChild(script);
            }
            else {
